              ...
              >
                ...
                <div className="p-7 space-y-4">
                  <a
                    ...
                    className="block text-lg font-semibold text-slate-900 hover:text-indigo-600 transition"
                  >
                    {article.title}
                  </a>
                ...
                {/* FOOTER */}
                <div className="px-7 py-5 border-t border-indigo-50 flex items-center justify-between">
